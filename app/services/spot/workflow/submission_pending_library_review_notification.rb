...
module Spot
  module Workflow
    class SubmissionPendingLibraryReviewNotification < AbstractNotification
      self.mailer_method = :submitted_pending_library_review
      ...
      def message
        "A work submitted by #{depositor.display_name} has been approved by its advisor (#{performing_user.display_name}) " \
