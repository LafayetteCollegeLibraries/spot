  ...
  module Derivatives
    ...
    class BaseDerivativeService
      ...
      def create_derivatives(file_path)
        ...
        extract_and_save_full_text(file_path) if full_text_eligible_types.include?(mime_type)
      end
      ...
      # Helper method to use MiniMagick to generate a 200x150 thumbnail
      ...
      def delete_thumbnail!
        FileUtils.rm_f(thumbnail_derivative_path)
      end
      ...
      def thumbnail_derivative_path
        Hyrax::DerivativePath.derivative_path_for_reference(file_set, 'thumbnail').to_s.tap do |path|
