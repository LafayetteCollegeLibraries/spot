  ...
  module Derivatives
    ...
    class VideoDerivativeService < AudioVisualBaseDerivativeService
      ...
      def check_transcript(filename)
        ...
        logger.warn { 'Transcript Name: ' + transcript_name }
        begin
          ...
          logger.warn { 'Transcript job enqueued.' }
        end
      end
