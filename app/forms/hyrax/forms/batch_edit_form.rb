...
#
# Copied this from Hyrax @ 780c148. We're not using the BasicMetadata
# mixin in our work models, and this form is expecting those fields to
# be present, which causes some gross errors on the UI side. I'll try
