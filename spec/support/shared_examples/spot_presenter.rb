  ...
  describe '#download_url' do
    ...
    context 'when a representative exists' do
      before do
        ...
        allow(Hyrax::MemberPresenterFactory).to receive(:new).and_return(member_presenter_factory)
        allow(member_presenter_factory).to receive(:member_presenters).with([member_id]).and_return([member_presenter])
      end
