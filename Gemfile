...
#
# @todo remove after Bulkrax integration added
...
#
# @todo is this necessary now that we're on Docker?
...
# error trackijng
#
# @todo may not be necessary on AWS? do we have a way
#       of triggering notices?
...
# system monitoring
#
# @todo Hyrax provides a zhealth (?) plugin, so this
...
group :development, :test do
  ...
  gem 'rspec', '3.12.0'
  gem 'rspec-its', '1.3.0' # @todo are we using this?
  gem 'rspec_junit_formatter', '0.4.1'
  gem 'rspec-rails', '5.1.2'
  gem 'shoulda-matchers', '4.5.1' # @todo are we using this?
